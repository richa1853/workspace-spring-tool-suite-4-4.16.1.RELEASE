...
public class BookDTO extends BaseDTO {
    ...
    public BookDTO() {}
    public BookDTO(@NotEmpty @Length(max = 13) @UniqueElements String ISBN, @NotEmpty @Length(max = 140) String title, @DecimalMax("199.99") @DecimalMin("0.0") Double price, @NotEmpty @Length(max = 155) String author, @Min(1) Integer pages, @NotEmpty @Length(max = 140) String provider) {
        super();
        this.ISBN = ISBN;
        this.title = title;
        this.price = price;
...
//	Builder builderr = BookDTO.newBookDTO();
    //builder obj
//    	BookDTO bookdto=new Builder().settId(null);
...
//        	return new BookDTO(id,ISBN,title,price,author,pages,provider );// BookDTO obj is returned
//        }
